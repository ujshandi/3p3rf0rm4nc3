...
{	
	...
	*/
		...
		for($i=0; $i<$leng; $i++){
			...
			$out .= '<fieldset class="sectionwrap">
								...
								<div class="fitem">
								  ...
								  <label style="text-align:right; width:10px">('.$capaian[1].'%)</label>
								</div>
								<div class="fitem">
	...
	private function getPendukung($tahun, $triwulan, $kode_sasaran_kl="", $kode_iku_kl=""){
		...
		$this->db->join('tbl_pk_eselon1 d', 'd.kode_iku_e1 = a.kode_iku_e1');
		...
		if ($i==1){
			$out2 .= '	  <tr>
							<td colspan="6">Data IKU Eselon I Tertaut ke IKU s.d. Bulan ini Tidak Ada. </td>
							</tr>';
		}
			$out2 .= '</table>';
