	...
	<div id="cc<?=$objectId;?>" class="easyui-layout" fit="true">  
		<div region="north" split="true" title="" style="height:450px;">
			...
			<!------------Edit View-->
				<div region="center" border="true" title="<?=($editMode=="true")?"Edit":"View"?> Data Pengukuran Kinerja Eselon I">	
					<form id="fmedit<?=$objectId;?>" method="post" style="margin:10px 5px 5px 10px;">		
						<input type="hidden" name="id_pengukuran_e1" value="<?=$result->id_pengukuran_e1?>">
						<div class="fitem">
						...
						<div class="fitem">
							...
							<span style="display:block;margin-left: 150px;"><?=$result->iku_e1?></span>
						</div>
						<div class="fitem">
