	...
	<table id="dg<?=$objectId;?>" style="height:auto;width:auto" title="Laporan Rencana Kinerja Tahunan Eselon 2" toolbar="#tb<?=$objectId;?>" fitColumns="true" singleSelect="true" rownumbers="false" pagination="true"  nowrap="false">
	  <thead>
	  <tr>
