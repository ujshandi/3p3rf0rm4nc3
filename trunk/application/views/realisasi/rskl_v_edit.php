		...
		$(function(){
		 	...
		 	saveDataEdit<?=$objectId;?>=function(){
				$('#fmedit<?=$objectId;?>').form('submit',{
					url: base_url+'realisasi/rskl/save_edit',
					onSubmit: function(){
			...
			<!------------Edit View-->
				<div region="center" border="true" title="<?=($editMode=="true")?"Edit":"View"?>  Data Realisasi Kinerja Kementerian">	
					<form id="fmedit<?=$objectId;?>" method="post" style="margin:10px 5px 5px 10px;">
						...
						<div class="fitem">
						  <label style="width:140px">Tahun :</label>
						  <?=$result->tahun?>
						</div>
						<div class="fitem">
						...
						<div class="fitem">
							<label style="width:140px">Sasaran :</label>
							<span style="display:block;margin-left: 140px;"><?=$result->sasaran?></span>
						</div>
						<div class="fitem">
							<label style="width:140px">Indikator Kinerja Utama :</label>
							<span style="display:block;margin-left: 140px;"><?=$result->iku_kl?></span>
						</div>
						<div class="fitem">
						...
						<div class="fitem">
						  <label style="width:140px">Rencana Aksi :</label>
