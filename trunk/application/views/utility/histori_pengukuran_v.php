	<script  type="text/javascript" >
		$(function(){
			...
			getUrl<?=$objectId;?> = function (tipe){
				...
				if (tipe==1){
					return "<?=base_url()?>utility/histori_pengukuran/"+unit+"_grid/"+filtahun+"/"+file1+"/"+file2;
				}
				else if (tipe==2){
					return "<?=base_url()?>utility/histori_pengukuran/"+unit+"_pdf/"+filtahun+"/"+file1+"/"+file2;
				}else if (tipe==3){
					return "<?=base_url()?>utility/histori_pengukuran/"+unit+"_excel/"+filtahun+"/"+file1+"/"+file2;
				}
			}
			...
			getColumn<?=$objectId;?> = function (){
				...
				switch(unit){
					case "KL": return 	[[
											...
											{field:'persetujuan',title:'Persetujuan',width:100},
			...
			<tr>
				...
				<div class="fsearch">
					...
					<tr>
						...
						<td width="130px"><?=$this->pengukurankl_model->getListFilterTahun($objectId);?>
						&nbsp;&nbsp;
						&nbsp;&nbsp;
	...
	<table id="dg<?=$objectId;?>" class="easyui-datagrid" style="height:auto;width:auto" title="Data Log Pengukuran Kinerja" toolbar="#tb<?=$objectId;?>" fitColumns="true" singleSelect="true" rownumbers="true" pagination="true">
	  <thead>
	  <tr>
