			...
			<tr>
				...
				<div class="fsearch">
					...
					<tr>
						...
						<td width="130px"><?=$this->rktkl_model->getListFilterTahun($objectId);?>
						&nbsp;&nbsp;
						&nbsp;&nbsp;
	...
	<table id="dg<?=$objectId;?>" class="easyui-datagrid" style="height:auto;width:auto" title="Data Log Rencana Kinerja Tahunan" toolbar="#tb<?=$objectId;?>" fitColumns="true" singleSelect="true" rownumbers="true" pagination="true">
	  <thead>
	  <tr>
